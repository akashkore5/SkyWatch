...
public class EmailsController {
    ...
    public void sendEmail(String recipientEmail, String link)
        ...
        helper.setFrom("support@dice.com", "Password Reset");
        ...
        String content = "<!DOCTYPE html>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style=\"margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;\"><span style=\"color:#8a3b8f;\"> SkyWatch &nbsp; © ·</span><span style> </span><span style><a href=\"http://"+link+"\" target=\"_blank\" style=\"text-decoration: underline; color: #8412c0;\" rel=\"noopener\">Unsuscribe</a></span></p>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\n" +
